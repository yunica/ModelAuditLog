...
class Audit:
    def __init__(self, request, obj):
        ...
        self.user_name = str(request.user.username)
    ...
    def create_audit(self, action='', field=False):
        ...
        audit.user_name = self.user_name
        audit.action = action
